...
dd = 0.12
vnames = [r'$g_1$',r'$\psi_{50,s}$',r'$\psi_{50,x}$',r'$g_{p,max}$',r'$C$']
clusternames = ['H'+str(i) for i in range(1,n_clusters+1)]
...
plt.legend(ncol=1,bbox_to_anchor=(1.03,1.03),title='HFT')
...
# cbar.set_label(varname,rotation=360,labelpad=15)
# plt.show()
plt.savefig('../Figures/Fig7b_clustermap.png',dpi=300,bbox_inches='tight')
...
clm_names = [r'$b_0$',r'$b_c$','Rnet','Temp','P','VPD','PET','DI']
