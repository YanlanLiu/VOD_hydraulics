...
if baseid==0:
    versionpath = parentpath + 'OSSE/Low/'; noise_level = 0.8
elif baseid==1:
    versionpath = parentpath + 'OSSE/Medium/'; noise_level = 1
elif baseid==2:
...
with open(datapath+'Gen_'+sitename+'_'+str(int(noise_level*100))+'.pkl', 'rb') as f: 
