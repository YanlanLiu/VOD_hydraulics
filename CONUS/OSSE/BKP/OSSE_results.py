...
# -*- coding: utf-8 -*-
"""
Created on Sun Aug  9 23:01:38 2020
...
sns.heatmap(BIAS,vmin=-1,vmax=1,cmap='RdBu')
plt.xticks([])
...
plt.figure(figsize=(6,4))
sns.heatmap(CVE,vmin=0,vmax=1,cmap='Blues')
plt.xticks([])
...
plt.figure(figsize=(6,4))
sns.heatmap(ACC,vmin=-1,vmax=1,cmap='RdBu')
plt.xticks([])
