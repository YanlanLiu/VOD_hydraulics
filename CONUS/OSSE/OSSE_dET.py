...
if baseid==0:
    versionpath = parentpath + 'OSSE_dET/Low/'; noise_level = 0
elif baseid==1:
    versionpath = parentpath + 'OSSE_dET/Medium/'; noise_level = 1
elif baseid==2:
    versionpath = parentpath + 'OSSE_dET/High/'; noise_level = 2
