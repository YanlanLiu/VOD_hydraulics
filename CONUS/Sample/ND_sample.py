...
# -*- coding: utf-8 -*-
"""
Created on Sat Aug  8 21:35:59 2020
...
Nobs = sum(valid_vod) + sum(valid_et)
...
if MODE == 'VOD_ET': 
    def Gaussian_loglik(theta0):
        ...
        ET_hat = dailyAvg(ET_hat,8)[valid_et]*24 # daily ET, mm/day
        dPSIL = hour2day(PSIL_hat,[amidx])[valid_vod]
        VOD_hat = fitVOD_RMSE(dPSIL,dLAI_valid,VOD_ma_valid)
    ...
    def Gaussian_loglik(theta0):
        ...
        SM_hat = hour2day(SM_hat,[amidx])[valid_sm]
