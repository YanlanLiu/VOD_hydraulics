...
from newfun_sm import readCLM # newfun_full
from newfun_sm import fitVOD_RMSE,dt, hour2day, hour2week
from newfun_sm import OB,CONST,CLAPP,ca,varnames
from newfun_sm import GetTrace
