...
# -*- coding: utf-8 -*-
"""
Created on Sat Jun 27 23:11:59 2020
...
# -*- coding: utf-8 -*-
"""
Created on Sun Jun 21 22:04:17 2020
...
def readCLM(inpath,sitename):
    ...
    # SOILM = np.reshape(np.column_stack([rm_outlier(amsr['SOILM_am']),rm_outlier(amsr['SOILM_pm'])]),[-1,])[~discard_vod]
...
#%% MCMC functions
varnames = ['g1','lpx','psi50X','gpmax','C','bexp','bc','evk','sigma_et','sigma_vod','sigma_sm','loglik']

p = int(len(varnames)-1)
lowbound = np.array([0,0,0,0,0,1.5,0,0,0,0,0])
upbound = np.array([10,1,15,10,23,10,1,1,3,.3,0.3])
